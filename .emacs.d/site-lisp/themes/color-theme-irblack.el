...
;;      (background-color . "#000000")
     ...
     (border ((t (:background "#888888" :foreground "#888888"))))
     (mode-line ((t (:background "#AAAAAA" :foreground "#000000"))))
     (mode-line-inactive ((t (:background "#333333" :foreground "#aaaaaa"))))
     ...
     ;; prompt
     (comint-highlight-prompt ((t (:foreground "#A8FF60"))))
